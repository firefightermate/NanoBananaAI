...
export const metadata = {
  ...
  description:
    "Generate and edit photoreal images from plain language. Powered by Google's nano banana image model. 50 free credits, no card required.",
  keywords: [
    "AI image generator",
    "nano banana",
    "text to image",
  ...
  openGraph: {
    title: `${config.appName} — ${config.tagline}`,
    description:
      "Generate and edit photoreal images from plain language. 50 free credits, no card required.",
    type: "website",
