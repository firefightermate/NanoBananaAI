...
const config = {
  ...
  stripe: {
    ...
    // 1 credit = 1 cent of pack value. Must stay in sync with PLANS in
    // src/app/pricing/page.js
    plans: {
      basic: { name: "Basic Pack", credits: 500, price: 500, currency: "usd" },
      standard: { name: "Standard Pack", credits: 1000, price: 1000, currency: "usd" },
      pro: { name: "Professional Pack", credits: 2000, price: 2000, currency: "usd" },
      business: { name: "Business Pack", credits: 5000, price: 5000, currency: "usd" },
    }
  },
  ai: {
    fal: {
